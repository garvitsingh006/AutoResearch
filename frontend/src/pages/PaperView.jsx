      ...
      <main className="max-w-3xl mx-auto px-4 md:px-6 pt-20 pb-12">
        {loading ? (
          <div className="pt-6">
            ...
            <h2 className="font-bebas text-4xl md:text-5xl text-white mb-8">RESUMING PIPELINE…</h2>
            <Loader />
          </div>
        ) : (
          <>
            <button
              ...
              className="font-inter font-bold text-xs text-white/40 uppercase tracking-widest mt-6 mb-8 flex items-center gap-2 hover:text-[#EBFF00] transition-colors"
            >
              ← BACK TO DASHBOARD
            </button>

            <div className="border-4 border-white/20 p-5 md:p-8 shadow-[8px_8px_0px_0px_rgba(255,0,85,0.3)]">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-3 border-t-4 border-white/10 pt-8">
                <button
                  onClick={handleResume}
                  className="font-bebas text-lg border-4 border-white text-white px-6 py-3 hover:bg-white hover:text-black transition-colors"
                >
                  ↺ RESUME / CONTINUE
                </button>
                <button
                  onClick={() => navigate("/new")}
                  className="font-bebas text-lg bg-[#FF0055] text-white border-4 border-[#FF0055] px-6 py-3 hover:bg-black hover:border-white transition-colors"
                >
                  NEW PAPER
                </button>
              </div>
